<?php namespace App\Http\Controllers;
	...
	class AdminBrUfController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Sigla','name'=>'sigla','type'=>'text','validation'=>'required|min:1|max:3','width'=>'col-sm-10'];
